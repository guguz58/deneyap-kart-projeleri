...
void notify()                           
{
  int yAxisValue =(Ps3.data.analog.stick.rx);  //Left stick  - y axis - forward/backward car movement
  int xAxisValue =(Ps3.data.analog.stick.ly);  //Right stick - x axis - left/right car movement
